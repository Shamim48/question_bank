...
<div class="space-y-8">
    ...
    <div>
        <h2 class="text-3xl font-display font-bold text-gray-900 mb-1">Pending User</h2>
            ...
            <div class="p-6 border-b border-gray-100 last:border-0">
                <div class="flex flex-col lg:flex-row gap-6 items-start">
                    ...
                    <div class="flex gap-2 shrink-0">
                        <form method="POST" action="{{ route('admin.users.approve', $team) }}">
                            @csrf
                            <button type="submit"
                        ...
                        <a href="{{ route('admin.users.reject', $team) }}"
